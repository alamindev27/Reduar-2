                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <h1>Global Bank Award {{ Carbon\Carbon::now()->format('Y') }}</h1>
                                    <p>Discover the winners across all categories, explore comprehensive top lists for deeper insights, and celebrate the honorable mentions among the contenders.</p>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">About Global Bank Award</h4>
                            </div>
                            <div class="card-body">
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-lg-9">
                                        <p>The Global Bank Award is a prestigious accolade recognizing outstanding achievements and excellence in the banking industry. Celebrated for its transparency and rigorous evaluation process, the award honors leading banks across various categories, setting the standard for innovation, reliability, and customer-centric services worldwide.</p>
                                    </div>
