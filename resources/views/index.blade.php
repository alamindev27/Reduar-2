...
<title>{{ $arr[1] }} - Forex No Deposit Bonus</title>
            ...
            <div class="container">
                <div class="row mb-3">
                    <div class="col-lg-8 mb-3 mb-lg-0">
                        ...
                        @if (advertisement(6)->status == 'unavailable')
                            <a href="{{ advertisement(6)->link }}" target="_blank">
                                <img src="{{ asset(advertisement(6)->image) }}" class="img-fluid w-100" alt="" style="width: 728px; height:90px;">
                            </a>
                        @endif
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-lg-4 mb-3">
                        ...
                        @if (advertisement(7)->status == 'unavailable')
                            <a href="{{ advertisement(7)->link }}" target="_blank">
                                <img src="{{ asset(advertisement(7)->image) }}" alt="" class="img-fluid common-rounded">
                            </a>
                        @endif
                    </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="d-flex justify-content-between align-items-center border-bottom">
                        <h6 class="section-title mb-0">{{ section(3)->name }}</h6>
                        <a href="#" class="text-muted text-decoration-none">View more &raquo;</a>
                    </div>
                    <div class="col-lg-8">
                        <div class="row">
                            @foreach (posts(3, 4) as $item)
                    ...
                    <div class="col-lg-4">
                        ...
                        @if (advertisement(8)->status == 'unavailable')
                            <a href="{{ advertisement(8)->link }}" target="_blank">
                                <img src="{{ asset(advertisement(8)->image) }}" alt="" class="img-fluid common-rounded">
                            </a>
                        @endif
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-lg-4">
                        ...
                        @if (advertisement(9)->status == 'unavailable')
                            <a href="{{ advertisement(9)->link }}" target="_blank">
                                <img src="{{ asset(advertisement(9)->image) }}" alt="" class="img-fluid common-rounded">
                            </a>
                        @endif
                    </div>
                    <div class="col-lg-8">
                        ...
                        <div class="row g-1 mt-2">
                            @foreach ($brokerReviews as $item)
                                <div class="col-lg-4 mb-1">
                                    <a href="{{ route('frontend.broker.details', $item->slug) }}" class="text-decoration-none text-dark" target="_blank">
                                        <div class="card">
