                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <h1>Global Online Bank {{ Carbon\Carbon::now()->format('Y') }}</h1>
                                    <p>Explore our associated top lists to gain in-depth insights into the best performers. Discover the honorable mentions among the contenders, showcasing outstanding achievements in the industry.</p>
                    ...
                    <div class="row mb-3">
                        <div class="d-block d-lg-flex justify-content-between align-itmes-center">
                            <div class="text-center text-lg-start">
                                <h2 class="fw-bold">Global Online Bank in {{ Carbon\Carbon::now()->format('Y') }}</h2>
