...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Bonus Category</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                    <li class="breadcrumb-item">Bonus Category</li>
                    <li class="breadcrumb-item active">List Bonus Category</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <section class="section">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">List Bonus Category</h5>
                                    ...
                                    @forelse ($datas as $key => $data)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{ route('forex-bonus-category.edit', $data->id) }}" class="btn btn-info btn-sm mx-1" target="_blank">Edit</a>
                                            </td>
                                        </tr>
                                    @empty
