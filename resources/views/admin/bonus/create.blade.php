        ...
        <section class="section">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('forex-bonus.store') }}" enctype="multipart/form-data">
                            @csrf
                            <h5 class="card-title">Bonus Details</h5>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="link_text" id="link_text"
                                                placeholder="Enter link_text" value="{{ old('link_text') }}">
                                            @error('link_text')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="step" id="step" rows="5" class="form-control" placeholder="Enter Step">{{ old('step') }}</textarea>
                                    @error('step')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="bonus" id="bonus"
                                                placeholder="Enter bonus" value="{{ old('bonus') }}">
                                            @error('bonus')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="promo_url" id="promo_url"
                                                placeholder="Enter promo url" value="{{ old('promo_url') }}">
                                            @error('promo_url')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="promo_text" id="promo_text"
                                                placeholder="Enter promo text" value="{{ old('promo_text') }}">
                                            @error('promo_text')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="bonus_2" id="bonus_2"
                                                placeholder="Enter bonus 2" value="{{ old('bonus_2') }}">
                                            @error('bonus_2')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="kyc" id="kyc"
                                                placeholder="Enter kyc" value="{{ old('kyc') }}">
                                            @error('kyc')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="contacts" id="contacts"
                                                placeholder="Enter contacts" value="{{ old('contacts') }}">
                                            @error('contacts')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
