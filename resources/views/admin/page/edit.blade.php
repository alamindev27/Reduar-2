                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('admin.page.update', $data->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    <label class="control-label pt-2" for="page_name">Page Name *</label>
                                    <input type="text" class="form-control" id="page_name" placeholder="Enter page name" value="{{ $data->name }}">
                                    @error('page_name')
