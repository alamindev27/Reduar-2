        ...
        <section class="section">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Add Crypto</h5>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="coin_name" id="coin_name"
                                                placeholder="Enter coin name" value="{{ old('coin_name') }}">
                                            @error('coin_name')
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="status" id="status" class="form-control">
                                                ...
                                                <option {{ old('status') == 'yes' ? 'selected' : '' }} value="yes"> Yes</option>
                                            </select>
                                            @error('status')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="origin" id="origin"
                                                placeholder="Enter origin" value="{{ old('origin') }}">
                                            @error('origin')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="symbol" id="symbol"
                                                placeholder="Enter symbol" value="{{ old('symbol') }}">
                                            @error('symbol')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="released_year" id="released_year"
                                                placeholder="Enter released year" value="{{ old('released_year') }}">
                                            @error('released_year')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="max_supply" id="max_supply"
                                                placeholder="Enter max supply" value="{{ old('max_supply') }}">
                                            @error('max_supply')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="showMainMenu" id="showMainMenu" class="form-control">
                                                <option {{ old('showMainMenu') == 'no' ? 'selected' : '' }} value="no"> No</option>
                                                <option {{ old('showMainMenu') == 'yes' ? 'selected' : '' }} value="yes"> Yes</option>
                                            </select>
                                            @error('showMainMenu')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
