        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">List Awards</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <section class="section">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">List Awards</h5>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="d-flex justify-content-start align-items-center">
                                                    <img src="{{ asset($data->logo) }}" alt="" width="50" class="border rounded" >
                                                    <span class="d-block ms-2">{{ $data->name }}</span>
                                                </div>
                                            </td>
                                            <td class="align-middle">{{ $data->award_year }}</td>
                                            <td class="align-middle">
                                                <div class="d-flex justify-content-start align-items-center">
                                                    <img src="{{ asset($data->image) }}" alt="" width="80" class="border rounded">
                                                    <span class="d-block ms-2">{{ $data->title }}</span>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <form action="{{ route('award.destroy', $data->id) }}" method="POST" class="text-nowrap">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('award.edit', $data->id) }}" class="btn btn-info btn-sm mx-1" target="_blank">Edit</a>
