        ...
        <section class="section">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('award.update', $data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <h5 class="card-title">Award Details</h5>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="award_year" id="award_year" class="form-control">
                                                ...
                                                @for ($i = $now - 14; $i <=  $now ; $i++)
                                                    <option {{ $data->award_year == $i ? 'selected' : '' }} value="{{ $i }}">{{ $i }}</option>
                                                @endfor
                                            </select>
                                            {{-- <input type="text" class="form-control" name="award_year" id="award_year"
                                                placeholder="Enter award year" value="{{ old('award_year') ?? $data->award_year }}"> --}}
                                            @error('award_year')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="png_download_link" id="png_download_link"
                                                placeholder="Enter png download link" value="{{ old('png_download_link') ?? $data->png_download_link }}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="psd_download_link" id="psd_download_link"
                                                placeholder="Enter psd download link" value="{{ old('psd_download_link') ?? $data->psd_download_link }}">
                                    ...
                                    <div class="col-lg-2">
                                        <br>
                                        <img src="{{ asset($data->logo) }}" alt="" width="60" class="border rounded">
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="award_type" id="award_type" class="form-control">
                                                ...
                                                <option {{ $data->type == 'forex_broker' ? 'selected' : '' }} value="forex_broker">Forex Broker Award</option>
                                                <option {{ $data->type == 'global_bank' ? 'selected' : '' }} value="global_bank">Global Bank Award</option>
                                                {{-- <option {{ $data->type == 'global_online' ? 'selected' : '' }} value="global_online">Global Online Bank</option> --}}
                                                <option {{ $data->type == 'pop_trading' ? 'selected' : '' }} value="pop_trading">Pop Trading Award</option>
                                            </select>
                                            @error('award_type')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
