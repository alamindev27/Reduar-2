        ...
        <section class="section">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">List Blogs</h5>
                                    ...
                                    @forelse ($datas as $key => $data)
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <form action="{{ route('blog.destroy', $data->id) }}" method="POST" class="text-nowrap">
                                                    @csrf
                                                    @method('DELETE')
                                                    <a href="{{ route('blog.edit', $data->id) }}" class="btn btn-info btn-sm mx-1" target="_blank">Edit</a>
