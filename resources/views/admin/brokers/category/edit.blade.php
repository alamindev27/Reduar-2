        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Broker Category</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <section class="section">
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Edit Broker Category</h5>
                            <form method="POST" action="{{ route('broker-category.update', $data->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
