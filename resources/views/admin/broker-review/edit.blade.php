        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Edit Broker Review</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        <section class="section">
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('broker-review.update', $data->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <h5 class="card-title">Review Details</h5>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="bestForexes" class="form-control" id="bestForexes" onchange="bestForexesCategory(this)">
                                                ...
                                                @foreach ($bestForexes as $category)
                                                    <option {{ $data->bestForexes_id == $category->id ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('bestForexes')
                                                <span class="text-danger">{{ $message }}</span>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="bestForexesSubCat_id" class="form-control" id="bestForexesSubCat_id" {{ empty($positionSubCat) ? 'disabled' : '' }}>
                                                @if ($positionSubCat)
                                                    <option value="{{ $positionSubCat->id }}">{{ $positionSubCat->name }}</option>
                                                @else
                                ...
                                <div class="form-group mb-3">
                                    <label class="control-label pt-2" for="short_description">Short Description *</label>
                                    <textarea name="short_description" id="short_description" rows="5" class="form-control" placeholder="Enter short description">{{ old('short_description') ?? $data->short_description }}</textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="brokers_name" id="brokers_name"
                                                placeholder="Enter brokers name" value="{{ old('brokers_name') ?? $data->brokers_name }}">
                                            @error('brokers_name')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="year_founded" id="year_founded"
                                                placeholder="Enter Year Founded" value="{{ old('year_founded') ?? $data->year_founded }}">
                                            @error('year_founded')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="headquarters" id="headquarters"
                                                placeholder="Enter Headquarters" value="{{ old('headquarters') ?? $data->headquarters }}">
                                            @error('headquarters')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="regulation" id="regulation"
                                                placeholder="Enter Regulation" value="{{ old('regulation') ?? $data->regulation }}">
                                            @error('regulation')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="us_clients" id="us_clients"
                                                placeholder="Enter US Clients" value="{{ old('us_clients') ?? $data->us_clients }}">
                                            @error('us_clients')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="support_email" id="support_email"
                                                placeholder="Enter Support Email" value="{{ old('support_email') ?? $data->support_email }}">
                                            @error('support_email')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="telephone" id="telephone"
                                                placeholder="Enter Telephone" value="{{ old('telephone') ?? $data->telephone }}">
                                            @error('telephone')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="languages" id="languages"
                                                placeholder="Enter Languages" value="{{ old('languages') ?? $data->languages }}">
                                            @error('languages')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="yes" id="support_247" name="support_247" {{ $data->support_247 == 'yes' ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="commission" id="commission"
                                                placeholder="Enter Commission" value="{{ old('commission') ?? $data->commission }}">
                                            @error('commission')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="accounts" id="accounts"
                                                placeholder="Enter Accounts" value="{{ old('accounts') ?? $data->accounts }}">
                                            @error('accounts')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="currencies" id="currencies"
                                                placeholder="Enter Currencies" value="{{ old('currencies') ?? $data->currencies }}">
                                            @error('currencies')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="execution" id="execution"
                                                placeholder="Enter Execution" value="{{ old('execution') ?? $data->execution }}">
                                            @error('execution')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="spreads" id="spreads"
                                                placeholder="Enter Spreads" value="{{ old('spreads') ?? $data->spreads }}">
                                            @error('spreads')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="trade_size" id="trade_size"
                                                placeholder="Enter Trade Size" value="{{ old('trade_size') ?? $data->trade_size }}">
                                            @error('trade_size')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="instruments" id="instruments"
                                                placeholder="Enter Instruments" value="{{ old('instruments') ?? $data->instruments }}">
                                            @error('instruments')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="yes" id="demo_trading" name="demo_trading" {{ $data->demo_trading == 'yes' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="yes" id="swap_free" name="swap_free" {{ $data->swap_free == 'yes' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="yes" id="copy_trading" name="copy_trading" {{ $data->copy_trading == 'yes' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="yes" id="crypto_trading" name="crypto_trading" {{ $data->crypto_trading == 'yes' ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="yes" id="mobile_trading" name="mobile_trading" {{ $data->mobile_trading == 'yes' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="yes" id="web_trading" name="web_trading" {{ $data->web_trading == 'yes' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="yes" id="affiliate" name="affiliate" {{ $data->affiliate == 'yes' ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="deposit" id="deposit" rows="5" class="form-control" placeholder="Enter deposit">{{ old('deposit') ?? $data->deposit }}</textarea>
                                            @error('deposit')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="withdrawal" id="withdrawal" rows="5" class="form-control" placeholder="Enter withdrawal">{{ old('withdrawal') ?? $data->withdrawal }}</textarea>
                                            @error('withdrawal')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="website_link" id="website_link"
                                            placeholder="Enter website link" value="{{ old('website_link') ?? $data->website_link }}">
                                        @error('website_link')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" min="0.1" step="0.1" class="form-control" name="review" id="review"
                                            placeholder="Enter review" value="{{ old('review') ?? $data->review }}">
                                        @error('review')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" min="1" step="1" class="form-control" name="total_ratings" id="total_ratings"
                                            placeholder="Enter total ratings" value="{{ old('total_ratings') ?? $data->total_ratings }}">
                                        @error('total_ratings')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <br>
                                    <img src="{{ asset($data->logo) }}" alt="" width="70" class="border rounded">
                                    <br>
                                </div>
                            </div>
