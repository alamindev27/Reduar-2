                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('best-forex-broker-sub-category.update', $data->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="form-group mb-3">
                                    ...
                                    <select name="category" id="category" class="form-control">
                                        ...
                                        @foreach ($categories as $category)
                                            <option {{ $data->bestForexBrokerCatId == $category->id ? 'selected' : '' }} value="{{ $category->id }}">{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select name="use_menu" id="use_menu" class="form-control">
                                        <option {{ $data->use_menu == 'no' ? 'selected' : '' }} value="no"> No</option>
                                        <option {{ $data->use_menu == 'yes' ? 'selected' : '' }} value="yes"> Yes</option>
                                    </select>
                                    @error('use_menu')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
